      ...
      <UModal title="Search" description="Search for articles by title or description.">
        <UTooltip :delay-duration="0"
          ...
          <UButton icon="i-heroicons-magnifying-glass"
                   ...
                   class="flex items-center justify-center rounded-xl p-2 text-sm font-medium transition-colors duration-150 ease-in bg-gray-50/25 hover:bg-gray-50/75 dark:bg-gray-950/25 dark:hover:bg-gray-950/75 cursor-pointer" />
        </UTooltip>
