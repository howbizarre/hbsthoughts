...
Много често, когато ползвате [*SaaS*&#x5D; *(Software as a Service)* услуги нямате достъп до логовете -
...
функцията я кръщавате `async tail(events, env, ctx)` и вече имате дефиниран *Tail Worker*.
