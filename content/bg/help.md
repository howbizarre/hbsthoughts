...
[**Кратък индекс**](/llms.txt "Кратък индекс на сайта за LLMs"){:rel="noopener" target="_blank"} на сайта, за да подпомогне Езиковите модели.

[**Разширен индекс**](/llms-full.txt "Разширен индекс на сайта за LLMs"){:rel="noopener" target="_blank"} на сайта, който включва и съдържанието на статиите.

[**MCP Сървър** ](/mcp "Model Context Protocol за данните в сайта"){:rel="noopener" target="_blank"}с един инструмент `/asc` за връщане на отговори свързани със статиите.
