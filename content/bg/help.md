...
[**Таговете**](/bg/tag "Тагове или още етикети"), или както още етикети, са лесен начин да филтрирате статиите, които виждате, в дадена област, технология, идея и т.н.
...
[**Кратък индекс**](https://thoughts.bizarre.how/llms.txt "Кратък индекс на сайта за LLMs"){:rel="noopener" target="_blank"} на сайта, за да подпомогне Езиковите модели.

[**Разширен индекс**](https://thoughts.bizarre.how/llms-full.txt "Разширен индекс на сайта за LLMs"){:rel="noopener" target="_blank"} на сайта, който включва и съдържанието на статиите.

[**MCP Сървър**](https://thoughts.bizarre.how/mcp "Model Context Protocol за данните в сайта"){:rel="noopener" target="_blank"} с един инструмент `/asc` за връщане на отговори свързани със статиите.
