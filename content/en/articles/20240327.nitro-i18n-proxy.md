...
Nitro has a description in the documentation on how to set up the devProxy, and everything works fine until I encountered a Nuxt application with an active **i18n** module with several language localizations and configured in a **prefix** strategy. With the prefix strategy, the URL address is automatically replaced and the devProxy stops working.
...
::comments{discussions="https://github.com/howbizarre/thoughts/discussions/10"}
::
