...
Just that - a super-fast operation that returns a string identifier. No *postback*, no 301 redirection, no unnecessary requests to the *back-end*. How the *back-end* understands what the context is, I will tell you some other time.
...
::comments{discussions="https://github.com/howbizarre/thoughts/discussions/7"}
::
