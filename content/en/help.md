...
[**Short index**](https://thoughts.bizarre.how/llms.txt "Short index of site data"){:rel="noopener" target="_blank"} of the site to assist Language Models.

[**An extended index**](https://thoughts.bizarre.how/llms-full.txt "Extended index of site data"){:rel="noopener" target="_blank"} of the site, which includes the content of the articles.

[**MCP Server**](https://thoughts.bizarre.how/mcp "Model Context Protocol for site data"){:rel="noopener" target="_blank"} with a tool `/asc` for returning answers related to the articles.
